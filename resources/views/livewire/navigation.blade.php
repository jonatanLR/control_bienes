...
$nav_links = [
    ...
    [
        'name' => 'Tipo Articulos',
        'route' => route('admin.tipo-articulos.index'),
        'active' => request()->routeIs('admin.tipo-articulos.*'),
        // 'active' => false,//request()->routeIs('home')
    ],
];
@endphp
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        ...
                        @foreach ($nav_links as $nav_link)
                            {{-- <a href="{{ $nav_link['route'] }}" :active="$nav_link['active']" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                {{ $nav_link['name'] }}
              </a> --}}
